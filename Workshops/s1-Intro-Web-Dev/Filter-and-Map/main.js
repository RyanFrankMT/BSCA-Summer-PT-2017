...
// ONE
// Map is an array method that takes a function as argument.
//This argument takes a minimum of two arguments, the first being the
//item element being iterated over, the second being the index of the
//item/element being iterated over
// Map returns a *new* array based upon what the function passed
...
//Return an array of objects of our numbers
// Ex: [{num 1}, {num 2},...]

let numberObjects = []

for(let i=0; i<numbers.length; i+=1){
  numberObjects.push({num: numbers[i] })
...
// Filter is an array method that takes a
//function as argument and based upon the truthiness of the conditional
//that the function returns for each item iterated over, returns a new
//array of the original array's elements if and only if that element being
//iterated over meets the conditional in the function
...
//Use filter and map to return an array
//of objects of numbers that are less than 5
